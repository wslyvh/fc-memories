...
export function OnThisDayHeader() {
  const today = new Date();

  return (
    <div className="w-full relative">
      {/* Main header background - spans full width */}
      <div className="w-full h-[180px] bg-gradient-to-r from-[#7a50c0] via-[#8660cc] to-[#7a50c0] rounded-t-xl relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-xl h-full overflow-hidden">
        ...
        <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col items-center z-20">
          <div className="w-[100px] h-[100px] bg-white rounded-xl shadow-[0_0_20px_5px_rgba(0,0,0,0.10)] flex flex-col items-center justify-center relative">
            ...
            <div className="absolute top-0 left-0 right-0 h-6 bg-[#8660cc] rounded-t-xl flex items-center justify-center">
